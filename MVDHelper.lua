...
sampAddChatMessage("[Sashe4ka Police Helper]: {FFFFFF}Ñêðèïò óñïåøíî çàãðóçèààëñÿ", 0x8B00FF)
sampAddChatMessage("[Sashe4ka Police Helper]: {FFFFFF}Àâòîðû:t.me/Sashe4ka_ReZoN",0x8B00FF)
...
local rang_n = 0
local colorList = {u8'Ñòàíäàðòíàÿ', u8'Êðàñíàÿ', u8'Çåë¸íàÿ',u8'Ñèíÿÿ', u8'Ôèîëåòîâàÿ'} -- ñîçäà¸ì òàáëèöó ñ íàçâàíèÿìè òåì
local colorListNumber = new.int(mainIni.theme.themeta) -- ñîçäà¸ì áóôåð ãäå áóäåò õðàíèòñÿ íîìåð âûáðàííîé òåìû
local colorListBuffer = new['const char*'][#colorList](colorList) -- ñîçäà¸ì áóôåð äëÿ ñïèñêà
...
theme = {
    ...
    },
    {
        change = function()
            ...
            imgui.GetStyle().Colors[imgui.Col.SliderGrab]             = ImVec4(0.24, 0.52, 0.88, 1.00)local search = imgui.new.char[256]() -- ñîçäà¸ì áóôåð äëÿ ïîèñêà
    ...
    function(player)
        ...
        if imgui.BeginChild('Name##'..tab, imgui.ImVec2(), true) then -- [Äëÿ äåêîðà] Ñîçäà¸ì ÷àéëä â êîòîðûé ïîìåñòèì ñîäåðæèìîå
            ...
            if tab == 1 then -- åñëè çíà÷åíèå tab == 1
                ...
                if imgui.Combo(u8'Òåìû',colorListNumber,colorListBuffer, #colorList) then -- ñîçäà¸ì êîìáî äëÿ âûáîðà òåìû
                    themeta = theme[colorListNumber[0]+1].change() -- ìåíÿåì íà âûáðàííóþ òåìó
            ...
            elseif tab == 7 then
                ...
                imgui.Text(u8'Ðàçðàáîò÷èê: @Sashe4ka_ReZoN')
                ...
                imgui.Text(u8'Îáíîâëåíèå 4.8 - Ïèñþí ïàòñîõè')
...
imgui.OnInitialize(function()
    ...
    theme[colorListNumber[0]+1].change() -- ïðèìåíÿåì öâåòîâóþ ÷àñòü
