...
sampAddChatMessage("[Sashe4ka Police Helper]: {FFFFFF}Авторы:t.me/Sashe4ka_ReZoN and t.me/daniel29032012",0x8B00FF)
    ...
    function(player)
        ...
        if imgui.BeginChild('Name##'..tab, imgui.ImVec2(), true) then -- [Для декора] Создаём чайлд в который поместим содержимое
            ...
            elseif tab == 7 then
                ...
                imgui.Text(u8'Разработчик: @Sashe4ka_ReZoN and @daniel29032012')
                ...
                imgui.Text(u8'Мунмонет зделан с помощью @UxyOy')
                ...
                imgui.Text(u8'Обновление 4.8 - Мунмонет,авто обнова')
